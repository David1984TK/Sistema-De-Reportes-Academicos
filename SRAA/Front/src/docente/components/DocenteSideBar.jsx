...
export default function DocenteSideBar({ setSession }) {
      ...
      <div style={{ display: "flex", flex: 1, overflow: "hidden" }}>
        ...
        >
          ...
          <div style={{ flex: 1, overflowY: "auto", paddingTop: "8px" }}>
            {[
              { to: "/docente/consulta-actividades",  label: "Generación y consulta de actividades académicas", end: true },
              { to: "/docente/registrar-actividades", label: "Registro de actividades" },
              { to: "/docente/calendario",            label: "Calendario de Actividades Académicas" },
              { to: "/docente/registro-reportes",    label: "Registro de reportes" },
              { to: "/docente/mi-perfil",             label: "Mi perfil" },
            ].map((item) => (
              <NavLink
                key={item.to}
                to={item.to}
